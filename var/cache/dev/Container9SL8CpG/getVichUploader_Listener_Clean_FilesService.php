 ...
 */
class getVichUploader_Listener_Clean_FilesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.files' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.files'])) {
            return $container->privates['vich_uploader.listener.clean.files'];
        }

        return $container->privates['vich_uploader.listener.clean.files'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('files', ($container->privates['vich_uploader.adapter.orm'] ?? ($container->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
