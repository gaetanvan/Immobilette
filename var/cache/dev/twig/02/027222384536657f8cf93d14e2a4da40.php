...
class __TwigTemplate_ecd1e7a7eee581fc280c219c25103f07 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row text-center mt-5\">
        <form class=\"col mx-5\" method=\"post\">
            ";
        // line 9
        ...
        // line 18
        echo "
            <h1 class=\"h3 mb-3 darkblue fw-600\">Connexion</h1>
            <label class=\"darkblue fw-600\" for=\"inputEmail\">Mail</label>
        ...
        echo "\" name=\"email\" id=\"inputEmail\" class=\"form-control mb-3\" autocomplete=\"email\" required autofocus>
            <label class=\"darkblue fw-600\" for=\"inputPassword\">Mot de passe</label>
        ...
        echo "\"
            ...
            ";
        // line 39
        echo "            <button class=\"backgroundDarkblue btnRadius btn text-white btn-lg btn-sm mt-3 px-3\" type=\"submit\">
                Connexion
            </button>
            <a class=\"d-block smallFont\" href=\"";
        // line 42
...
";
    ...
    {
        return array (  141 => 42,  136 => 39,  130 => 26,  122 => 21,  117 => 18,  109 => 15,  106 => 14,  104 => 13,  101 => 12,  95 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    ...
    <div class=\"row text-center mt-5\">
        <form class=\"col mx-5\" method=\"post\">
            ...
            #}
            <button class=\"backgroundDarkblue btnRadius btn text-white btn-lg btn-sm mt-3 px-3\" type=\"submit\">
                Connexion
            </button>
            <a class=\"d-block smallFont\" href=\"{{ path('app_register') }}\">Inscription</a>
        </form>
    </div>
{% endblock %}
", "security/login.html.twig", "C:\\laragon\\www\\Immobilette\\templates\\security\\login.html.twig");
    }
}
