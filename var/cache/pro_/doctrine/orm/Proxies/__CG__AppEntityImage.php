...
class Image extends \App\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Image' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Image' . "\0" . 'property'];
        }
     ...
     * {@inheritDoc}
     */
    public function setProperty(?\App\Entity\Property $property): \App\Entity\Image
    {
